 ...
 */
public class ShopCategoriesRecyclerViewAdapter extends RecyclerView.Adapter<GenericViewHolder> {

    private final List<Category> mValues;
    private final OnListFragmentListener<Category> mListener;
    Context context;

    public ShopCategoriesRecyclerViewAdapter(Context context, List<Category> items, OnListFragmentListener<Category> listener) {
        mValues = items;
        mListener = listener;
